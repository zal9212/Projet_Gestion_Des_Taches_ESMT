...
@Component({
    ...
    <div class="relative z-10 flex h-screen w-full items-center justify-center p-4 lg:p-6 overflow-hidden font-dmsans">
      ...
      @if (auth.isAuthenticated()) {
        ...
        <div class="flex w-full max-w-[1300px] h-full bg-[#0a122d]/88 backdrop-blur-[20px] rounded-[32px] border border-border-col overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.6)] animate-in fade-in zoom-in-95 duration-500">
          
          <!-- SIDEBAR synchronized with Django -->
          <aside class="sidebar" style="height: 100%; display: flex; flex-direction: column; padding: 32px 24px; background: rgba(6, 13, 31, 0.4); border-right: 1px solid rgba(255, 255, 255, 0.08);">
            <div class="flex items-center justify-center mb-10 overflow-hidden shrink-0">
            ...
            <nav class="flex-1 flex flex-col gap-2 overflow-y-auto pr-1">
                ...
                <!-- Mes Projets -->
                <a class="nav-item" href="/" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: rgba(200, 215, 240, 0.6); text-decoration: none; transition: all 0.2s;">
                ...
                <!-- Mes Tâches -->
                <a class="nav-item" routerLink="/dashboard" routerLinkActive="active" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: rgba(200, 215, 240, 0.6); text-decoration: none; transition: all 0.2s;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <!-- Statistiques & Primes -->
                <a class="nav-item" href="/stats-primes/" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: rgba(200, 215, 240, 0.6); text-decoration: none; transition: all 0.2s;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <!-- Calendrier -->
                <a class="nav-item" href="javascript:void(0)" onclick="alert('Calendrier bientôt disponible !')" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: rgba(200, 215, 240, 0.6); text-decoration: none; transition: all 0.2s;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div style="margin-top: auto; display: flex; flex-direction: column; gap: 8px; padding-top: 24px; border-top: 1px solid rgba(255, 255, 255, 0.08);">
                <!-- Paramètres -->
                <a class="nav-item" href="/accounts/profile/" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: rgba(200, 215, 240, 0.6); text-decoration: none; transition: all 0.2s;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <!-- Déconnexion -->
                <a class="nav-item" href="javascript:void(0)" (click)="onLogout()" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-radius: 12px; font-size: 13.5px; font-weight: 500; color: #f87171; text-decoration: none; transition: all 0.2s;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
